...
mod tests {
    ...
    fn check_neg() {
        ...
        let v_neg = Vec3::new(-1.0, -2.0, -3.0);
        v = -v;
        assert_eq!(v, v_neg);
    }
    ...
    fn check_mul_assign() {
        let mut v = Vec3::new(1.0, 2.0, 3.0);
        let v_doubled = Vec3::new(2.0, 4.0, 6.0);
        v *= 2.0;
    ...
    fn check_div_assign() {
        ...
        let v_halved = Vec3::new(1.0, 2.0, 3.0);
        v /= 2.0;
    ...
    #[test]
    fn format_test() {
        let v: Vec3 = Vec3::new(1.1, 2.2, 3.3);
        assert_eq!(format!("{v}"), "1.1 2.2 3.3");
    }

    #[test]
    fn add_test() {
        let u: Vec3 = Vec3::new(1.0, 1.0, 1.0);
        let v: Vec3 = Vec3::new(3.0, 2.0, 1.0);

        let result: Vec3 = Vec3::new(4.0, 3.0, 2.0);
    ...
    fn sub_test() {
        ...
        let result: Vec3 = Vec3::new(-2.0, -1.0, 0.0);
        assert_eq!(u - v, result);
    }

    #[test]
    fn mul_test() {
        let u: Vec3 = Vec3::new(2.0, 3.0, 4.0);
        let v: Vec3 = Vec3::new(2.0, 3.0, 4.0);

        let result: Vec3 = Vec3::new(4.0, 9.0, 16.0);
        assert_eq!(u * v, result);
    }
    ...
    fn mul_lhs_double_test() {
        let v: Vec3 = Vec3::new(2.0, 3.0, 4.0);
        let result: Vec3 = Vec3::new(6.0, 9.0, 12.0);
    ...
    fn div_test() {
        let v: Vec3 = Vec3::new(2.0, 3.0, 4.0);
        let result: Vec3 = Vec3::new(1.0, 1.5, 2.0);
    ...
    fn cross_test() {
        ...
        let result = Vec3::new(-2.0, 4.0, -2.0);
    ...
    fn unit_vector_test() {
        ...
        let result = Vec3::new(1.0 / v_length, 2.0 / v_length, 3.0 / v_length);
    ...
    #[test]
    fn add_equals() {
        let mut v: Vec3 = Vec3::new(0.0, 0.0, 0.0);
        for i in 0..100 {
            v += Vec3::new(i as f64, i as f64, i as f64);
        }
